      ...
      <div className="row">
        ...
        <div className="col-xl-4 col-md-4 mb-30">
          <div className="single-cta">
            ...
            <div className="cta-text">
              <h4>Mail us</h4>
              <span>organichealthyfood@mail.com</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="col-xl-4 col-lg-4 mb-50">
          <div className="footer-widget">
            ...
            <div className="footer-text">
              <p>There are tons of diets out there — we break them down for you so you can learn which ones might fit your needs.</p>
            </div>
      ...
      <div className="row">
        <div className="col-xl-6 col-lg-6 text-center text-lg-left">
          <div className="copyright-text">
            <p>Copyright © 2024, All Right Reserved Organic Healthy Food.</p>
          </div>
        </div>
