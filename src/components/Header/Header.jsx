        ...
        <Row>
          <Col md={6}>
            <div className="head_left">
              ...
              There are many healthy, nutritious ingredients that you can include in your salad. These ingredients help with weight loss and provide you with other added benefits.
              </p>
            ...
            <div className="box">
              <div className="boxContianer d-flex">
                ...
                <div className="w-100">
                  ...
                  <p className='text-secondary'>Carbohydrates, along with protein and fat, are vital macronutrients that give the body energy for overall health.</p>
                </div>
              </div>
            </div>
          </Col>
            ...
            <div className="box">
              <div className="boxContianer d-flex">
                ...
                <div className="w-100">
                  ...
                  <p className='text-secondary'> The most reliable and fastest courier service in India. It will only take a few minutes to get your delivery on its way to you and to get ...</p>
                </div>
              </div>
            </div>
          </Col>
            ...
            <div className="box">
              <div className="boxContianer d-flex">
                ...
                <div className="w-100">
                  ...
                  <p className='text-secondary'>your thoughts are valuable in helping improve our products.</p>
                </div>
              </div>
            </div>
          </Col>
